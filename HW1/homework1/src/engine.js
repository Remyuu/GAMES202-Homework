...
function GAMES202Main() {
	...
	function createGUI() {
		...
		Object1Folder.add(ObjGUI.Pos1, 'modelTransX').min(-200).max( 200).step(1).name("Obj1 Pos X");
		Object1Folder.add(ObjGUI.Pos1, 'modelTransY').min(-200).max( 200).step(1).name("Obj1 Pos Y");
		Object1Folder.add(ObjGUI.Pos1, 'modelTransZ').min(-200).max( 200).step(1).name("Obj1 Pos Z");
